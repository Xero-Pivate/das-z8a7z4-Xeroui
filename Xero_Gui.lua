...
function ui:win()
    ...
    Mainpagt.BackgroundColor3 = Color3.fromRGB(245 , 65, 65)
...
local texth2 = Instance.new("TextLabel")
    ...
    texth2.Text = "HUB"
    texth2.TextColor3 = Color3.fromRGB(245, 65, 65)
...
local namehu = Instance.new("TextLabel")
    ...
    JoinButton.Text = "Join Xero Hub"
    JoinButton.TextColor3 = Color3.fromRGB(245,65,65)
    ...
    SearchStroke.Color = Color3.fromRGB(245,65,65)
    ...
    Logohub.Image = "http://www.roblox.com/asset/?id=10220594972"
    ...
    Logo.Position = UDim2.new(0.06, 0, 0.06, 0)
    ...
    Logo.Image = "http://www.roblox.com/asset/?id=10220594972"
    ...
    tween:Create(Main,TweenInfo.new(0,Enum.EasingStyle.Back),{Size = UDim2.new(0, 570, 0, 550)}):Play()
    ...
    game:GetService("UserInputService").InputBegan:Connect(function(input)
        if input.KeyCode == Enum.KeyCode.RightControl then 
            if library.toggledui == false then
                ...
                tween:Create(Main,TweenInfo.new(0,Enum.EasingStyle.Back,Enum.EasingDirection.In),{Size = UDim2.new(0, 0, 0, 0)}):Play()
            else 
...
function tap:addtap(text)
    ...
    MainFramePage.BackgroundColor3 = Color3.fromRGB(245, 65, 65)
    MainFramePage.BorderSizePixel = 0
    MainFramePage.Position = UDim2.new(0, 0, 0.141772151, 150)
    MainFramePage.Size = UDim2.new(0, 0, 0, 0)
    ...
    ScolPage.ScrollBarImageColor3 =  Color3.fromRGB(245, 65, 65)
...
function page:addpage()
    ...
    Page.BackgroundColor3 = Color3.fromRGB(245, 65, 65)
...
function ems:Button(text,callback)
    ...
    TextLabel_emsTextButton.BackgroundColor3 = Color3.fromRGB(245, 65, 65)
    ...
    TextLabel_emsTextButton.TextColor3 = Color3.fromRGB(245,65,65)
    ...
    MheeFrameStroke.Color = Color3.fromRGB(245, 65, 65)
    ...
    --    if joincheck.check1 == false then
            ...
            TweenService:Create(
                ...
                {BackgroundColor3 =  Color3.fromRGB(245, 65, 65)} -- UDim2.new(0, 128, 0, 25)
            ):Play()
--     end
...
function ems:Button1(text,callback)
    ...
    ToggleFrame1.BackgroundColor3 = Color3.fromRGB(245, 65 ,65)
    ...
    local Button_Logo = Instance.new("ImageLabel")
    Button_Logo.Name = "Button_Logo"
    Button_Logo.Parent = ToggleFrame1
    Button_Logo.AnchorPoint = Vector2.new(0.5, 0.5)
    Button_Logo.Position = UDim2.new(0, 15, 0, 9)
    Button_Logo.BackgroundTransparency = 1
    Button_Logo.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
    Button_Logo.BorderColor3 = Color3.fromRGB(27, 42, 53)
    Button_Logo.BorderSizePixel = 0
    Button_Logo.Size = UDim2.new(0, 25, 0, 20)
    Button_Logo.Image = "http://www.roblox.com/asset/?id=10219682143"
    ...
    MheeFrameStroke1.Color = Color3.fromRGB(245, 65 ,65)
...
function  ems:Toggle(text,de,callback)
    ...
    ToggleButton2.BackgroundColor3 = Color3.fromRGB(245, 65, 65)
    ...
    TextLabelToggle.BackgroundColor3 = Color3.fromRGB(245, 65, 65)
    TextLabelToggle.AnchorPoint = Vector2.new(0.5, 0.5)
    TextLabelToggle.Position = UDim2.new(0.64, 0, 0.4, 0)
    TextLabelToggle.Size =  UDim2.new(0, 100, 0, 40)
    ...
    TextButton_2_Toggle.BackgroundColor3 = Color3.fromRGB(245,65,65)
    ...
    TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(245, 65, 65)
    ...
    ImageLabel_Toggle.Image = "rbxassetid://10232547223"
...
function ems:Dropdown(text,text2,list,callback)
    ...
    listDropButton.TextColor3 = Color3.fromRGB(245, 65, 65)
    listDropButton.TextSize = 11.000
    listDropButton.AutoButtonColor = false 
    listDropButton.AnchorPoint = Vector2.new(0.5, 0.5)
    listDropButton.Position = UDim2.new(0.5, 0, 0.5, 0)
...
function ems:Slder(text,min,max,de,callback)
    ...
    SlisFrameStroke.Color = Color3.fromRGB(245,65,65)
    ...
    TalabelSlider.BackgroundColor3 = Color3.fromRGB(245, 65, 65)
    ...
    MainValue.BackgroundColor3 = Color3.fromRGB(245, 65, 65)
...
function ems:Ti(text)
    ...
    lineframe.BackgroundColor3 = Color3.fromRGB(245, 65 ,65)
    ...
    lineframe2.BackgroundColor3 = Color3.fromRGB(245,65,65)
    ...
    lineframe3.TextColor3 = Color3.fromRGB(245, 65, 65)
